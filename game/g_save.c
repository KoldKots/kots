...
void InitGame (void)
{
    ...
    // latched vars
    //SWB - changed to nosetm
    sv_cheats = gi.cvar ("cheats", "0", CVAR_SERVERINFO | CVAR_NOSET);
    ...
    deathmatch = gi.cvar ("deathmatch", "1", CVAR_NOSET | CVAR_LATCH);
    coop = gi.cvar ("coop", "0", CVAR_NOSET | CVAR_LATCH);
    skill = gi.cvar ("skill", "5", CVAR_NOSET | CVAR_LATCH);
    maxentities = gi.cvar ("maxentities", "1024", CVAR_LATCH);

    // change anytime vars
    dmflags = gi.cvar ("dmflags", "0", CVAR_SERVERINFO | CVAR_NOSET | CVAR_LATCH);
    fraglimit = gi.cvar ("fraglimit", "0", CVAR_SERVERINFO |CVAR_NOSET |  CVAR_LATCH);
    timelimit = gi.cvar ("timelimit", "0", CVAR_SERVERINFO | CVAR_NOSET | CVAR_LATCH);
    ...
    kots_nas = gi.cvar("nas", "0", CVAR_USERINFO);
    kots_maplist = gi.cvar("maplist", "", CVAR_SERVERINFO);
    kots_maprotate = gi.cvar("maprotate", "1", CVAR_SERVERINFO);
    ...
    //force the version to get updated
    gi.cvar_forceset(gamever->name, KOTS_VERSION);

    //SWB - announce the version
    gi.dprintf("Starting %s\n", gamever->string);
