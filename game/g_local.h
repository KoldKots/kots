...
//SWB
//rpcndr.h which is included when using windows.h
//includes a definition for hyper so lets undefine it here
#undef hyper
...
//SWB
//kots cvar list
extern cvar_t *kots_pass;
extern cvar_t *kots_nas;
extern cvar_t *kots_maplist;
extern cvar_t *kots_maprotate;
extern cvar_t *kots_public;
extern cvar_t *kots_motd;
extern cvar_t *kots_prevmaps;
extern cvar_t *gamever;
...
//SWB - KOTS Damage Flags
#define DAMAGE_NO_RESIST        0x00000040  /* resistances are not taken into account */
#define DAMAGE_NO_BONUS         0x00000080  /* damage based skills aren't done */
#define DAMAGE_STUN             0x00000100
#define DAMAGE_DIZZY            0x00000200
#define DAMAGE_EMP              0x00000400
#define DAMAGE_ALL_ARMOR        0x00000800
...
//SWB
void UpdateAllChaseCams(edict_t *ent);
...
struct gclient_s
{
    ...
    //Keep some extra sabre frame information
    float           sabre_refire;
    float           sabre_frame;
};
...
//SWB
//include character here so we don't have to include it in other files
